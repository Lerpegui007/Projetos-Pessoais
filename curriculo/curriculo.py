...
tk.Label(janela, text="Perfil profissional:").grid(row=5, column=0, padx=10, pady=5, sticky="nw")
entrada_perfil = tk.Text(janela, width=50, height=4)
entrada_perfil.grid(row=5, column=1, padx=10, pady=5)

tk.Label(janela, text="Habilidades:").grid(row=6, column=0, padx=10, pady=5, sticky="nw")
entrada_habilidades = tk.Text(janela, width=50, height=4)
entrada_habilidades.grid(row=6, column=1, padx=10, pady=5)

tk.Label(janela, text="Experiência profissional:").grid(row=7, column=0, padx=10, pady=5, sticky="nw")
entrada_experiencia = tk.Text(janela, width=50, height=6)
entrada_experiencia.grid(row=7, column=1, padx=10, pady=5)

tk.Label(janela, text="Formação acadêmica:").grid(row=8, column=0, padx=10, pady=5, sticky="nw")
entrada_formacao = tk.Text(janela, width=50, height=4)
entrada_formacao.grid(row=8, column=1, padx=10, pady=5)

tk.Button(janela,text="Gerar Currículo",command=gerar).grid(row=9, column=0, columnspan=2, pady=20)
